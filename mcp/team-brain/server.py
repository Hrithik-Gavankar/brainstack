...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Long sessions: after a research block or ~every 8–10 turns, quiet "
        "recall/prepare_research (do not spam every turn); optional once-per-spike "
        "background watch via CLI. watch does not replace wake. "
