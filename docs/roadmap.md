...
- [x] **Team aggregation metrics** — coverage matrix + reuse/activity via `metrics --team` (#35); collab graph / heatmap deferred — see [team-brain-memory.md](team-brain-memory.md) · parent [#2](https://github.com/Hrithik-Gavankar/engineer-brain/issues/2)
